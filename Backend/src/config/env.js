...
const aliasMap = [
    ...
    ['GOOGLE_CLIENT_ID', pickEnv('GOOGLE_CLIENT_ID', 'GOOGLE_CLINET_ID', 'GOOGLE_OAUTH_CLIENT_ID', 'APP_GOOGLE_OAUTH_CLIENT_ID')],
    ['GOOGLE_CLIENT_SECRET', pickEnv('GOOGLE_CLIENT_SECRET', 'GOOGLE_OAUTH_CLIENT_SECRET', 'APP_GOOGLE_OAUTH_CLIENT_SECRET')],
    ['GOOGLE_OAUTH_CLIENT_ID', pickEnv('GOOGLE_OAUTH_CLIENT_ID', 'GOOGLE_CLIENT_ID', 'GOOGLE_CLINET_ID', 'APP_GOOGLE_OAUTH_CLIENT_ID')],
    ...
    ['GITHUB_CLIENT_ID', pickEnv('GITHUB_CLIENT_ID', 'GITHUB_CLINET_ID', 'GITHUB_OAUTH_CLIENT_ID', 'APP_GITHUB_OAUTH_CLIENT_ID')],
    ['GITHUB_CLIENT_SECRET', pickEnv('GITHUB_CLIENT_SECRET', 'GITHUB_OAUTH_CLIENT_SECRET', 'APP_GITHUB_OAUTH_CLIENT_SECRET')],
    ['GITHUB_OAUTH_CLIENT_ID', pickEnv('GITHUB_OAUTH_CLIENT_ID', 'GITHUB_CLIENT_ID', 'GITHUB_CLINET_ID', 'APP_GITHUB_OAUTH_CLIENT_ID')],
